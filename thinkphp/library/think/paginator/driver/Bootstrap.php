...
class Bootstrap extends Paginator
{
    ...
    protected  function  gopage()
    {
        ...
        return $gotohtml='<li><form action="" method="get" class="pageform" ><span><input type="text" name="page" class="pagetext"> <input type="submit" value="确定" class="pagesubmit"> </span></form></li>';
       // return $totalhtml;;
        ...
        if ($this->hasPages()) {
            if ($this->simple) {
                ...
                return sprintf(
                    ...
                    $this->totalshow(),//显示数量页码信息 
                    $this->home(),//第一页
                    $this->getPreviousButton(),//上一页
                    $this->getLinks(),//页码
                    $this->getNextButton(),//下一页
                    $this->last(),//最后一页
                    $this->gopage()//最后再加个参数 %s 可以显示跳转到哪页
                );
            }
        }
    }
