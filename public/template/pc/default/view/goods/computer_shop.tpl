...
<html>
    <head>
        ...
        <link rel="stylesheet" type="text/css" href="__PC__/css/goods/computer_shop.css" />
    </head>
    <body>
        <div class="pcdiv-all">
            ...
            <div class="kejia-all pcdiv-auto">
                ...
                <div class="advert-img pcdiv-auto">
                    <a href="{$computer_shop_advert20['adv_link']}"><img src="__STATIC__/{$computer_shop_advert20['dire']}"/></a>
                </div>
            </div>

            {include file="public/bottom" /}
        </div>
        <script type="text/javascript" src="__PC__/js/goods/computer_shop.js"></script>
    </body>
</html>
