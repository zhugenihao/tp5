...
<html>
    <head>
        ...
        <link rel="stylesheet" type="text/css" href="__PC__/css/goods/supermarket.css" />
    </head>
    <body>
        <div class="pcdiv-all">
            ...
            <div class="kejia-all pcdiv-auto">
                ...
                <div class="advert-img pcdiv-auto">
                    ...
                    <a href="{$supermarket_advert20['adv_link']}"><img src="__STATIC__/{$supermarket_advert20['dire']}"/></a>
                    {/if}
                </div>
            </div>
        ...
        <script type="text/javascript" src="__PC__/js/goods/supermarket.js"></script>
    </body>
</html>
