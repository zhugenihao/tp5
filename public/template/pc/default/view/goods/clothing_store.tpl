        ...
        <div class="pcdiv-all">
            ...
            <div class="kejia-all pcdiv-auto">
                ...
                <div class="advert-img pcdiv-auto">
                    <a href="{$clothing_store_advert20['adv_link']}"><img src="__STATIC__/{$clothing_store_advert20['dire']}"/></a>
                </div>
            </div>

            {include file="public/bottom" /}
        </div>
        <script type="text/javascript" src="__PC__/js/goods/clothing_store.js"></script>
    </body>
</html>
