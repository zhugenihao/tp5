...
<div class="seller-allas">
    <div class="member-yue"><span>运营情况</span></div>
...
{include file="public/plugin/runreports" /}
<script type="text/javascript" src="__PC__/js/seller_statselement/situation/runreports.js"></script>
