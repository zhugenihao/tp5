...
<html>
    ...
    <body>
                ...
                <div class="pcdiv-auto">
                    <div class="membertext-all">
                        ...
                        <div class="member-right floatleft">
                            <div class="kejia-all">
                                <div class="kejia-top">
                                    <div class="member-title floatleft"><span>浏览过的商品({$count_all})</span></div>
                                    <div class="floatright"><a href="javascript:;" onclick="deleteWatchHistory(this)">立即清空</a></div>
                                </div>
        ...
        <script type="text/javascript" src="__PC__/js/member/watch_history.js"></script>
    </body>
</html>
