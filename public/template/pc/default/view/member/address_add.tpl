...
<html>
    ...
    <body>
                            ...
                            <div class="member-text">
                                <form class="layui-form" action="" id="formsubmit">
                                    <div class="address-auto">
                                        <div class="address_div">添加收货地址</div>
                                        <div class="address_div">收货人：<input type="text" name="ads_name" id="ads_name" class="member_text3" placeholder="输入收货人" /></div>
                                        <div class="address_div">联系方式：<input type="text" name="ads_mobile" id="ads_mobile" class="member_text4" placeholder="输入联系方式"/></div>
                                        ...
                                        <div class="address_tdiv address_div">
                                            <p>详细地址：</p>
                                            <p><textarea class="address_text" name="detaddress" placeholder="输入详细地址" id="detaddress"></textarea></p>
                                        </div>
                                        <div class="addrsbz_div floatfalse">
                                            <div>地址标志：</div>
                                            <ul class="addrsbz_ul" id="address_sign">
                                                {volist name="AddressSignList" id="vo"}
                                                <li data-id="{$vo['id']}">{$vo['sign_name']}</li>
                                                {/volist}
                                                {volist name="memberAddressSignList" id="vo"}
                                                <li data-id="{$vo['id']}">{$vo['sign_name']}
                                            ...
                                            <input type="hidden" value="0" name="sign_id" class="sign_id">
                                        </div>
                                        <div class="address_mrdiv address_div">
                                            <p class="floatleft">默认收货地址：</p>
                                            <div class="layui-input-block floatleft">
                                                <input type="checkbox" name="ads_default" checked lay-skin="switch" lay-text="ON|OFF">
                                            </div>
                                        </div>
                                        <div class="upbtn_div floatfalse"><input type="button" value="立即添加" class="update_btn1" onclick="submitAddress(this)"/></div>
                                    </div>
                                </form>
                            </div>
        ...
        <script type="text/javascript" src="__PC__/js/member/address_add.js"></script>
    </body>
</html>
