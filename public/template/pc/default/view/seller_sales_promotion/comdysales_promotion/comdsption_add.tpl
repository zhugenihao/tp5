...
<div class="seller-allas">
    <div class="member-yue"><span>添加促销</span></div>
            ...
            <form action="" method="post" id="brand_from" name="submitfrom" enctype="multipart/form-data">
                <div class="fromtext_auto">
                    <div class="div_texts">
                        ...
                        <div class="form_text">
                            <input type="text" value="商品促销" name="cp_name" placeholder="请输入促销名称" class="mall_input" id="cp_name" size="40">
                        </div>
                    </div>
                    <div class="div_texts">
                        <label class="form_title">
                        ...
                        <div class="form_text">
                            <select name="cp_type" id="cp_type" onchange="cpType(this)">
                                <option value="1" >直接打折</option>
                                <option value="2" >减价优惠</option>
                            </select>
                        </div>
                    </div>
                    <div class="div_texts">
                        <label class="form_title" id="cptypes_title">
                            <i class="Hui-iconfont color-red">&#xe630;</i>
                            <span id="discount_title">折扣(如：7.5)：</span>
                            <span id="cpprice_title">促销价格(￥)：</span>
                        </label>
                        <div class="form_text" id="cptypes_text">
                            <input type="text" name="discount" value="9.0" class="mall_input" id="discount" size="40">
                            <input type="text" name="cp_price" value="1.00" class="mall_input" id="cp_price" size="40">
                        </div>
                    </div>
                    <div class="div_texts">
                        <label class="form_title">
                        ...
                        <div class="form_text">
                            <input type="text" name="cp_num" value="10" class="mall_input" id="cp_num" size="40">
                        </div>
                    </div>
                    <div class="div_texts">
                        <label class="form_title">
                    ...
                    <div class="goodsbtn_div formdiv_btn">
                        ...
                        <botton class="goods_btn goodsbtn_act" onclick="addComdsption(this)">添加</botton>
                    </div>
                </div>
            </form>
        </div>
...
<script type="text/javascript" src="__PC__/js/seller_sales_promotion/comdysales_promotion/comdsption_add.js"></script>
