...
<div class="seller-allas">
    <div class="member-yue"><span>编辑拼团</span></div>
            ...
            <form action="" method="post" id="brand_from" name="submitfrom" enctype="multipart/form-data">
                <div class="fromtext_auto">
                    ...
                    <div class="div_texts">
                        ...
                        <div class="form_text">
                            <input type="text" name="sg_price" value="{$info['sg_price']}" class="mall_input" id="sg_price" size="40">
                        </div>
                    </div>
                    ...
                    <div class="div_texts">
                        ...
                        <div class="form_text">
                            <input type="text" value="{$info['sg_num']}" name="sg_num" class="mall_input" id="sg_num" size="40">
                        </div>
                    </div>
                    <div class="div_texts">
                        <label class="form_title">
                        ...
                        <div class="form_text">
                            <input type="text" value="{$info['sg_members_num']}" name="sg_members_num" class="mall_input" id="sg_members_num" size="40">
                        </div>
                    </div>
                    <div class="div_texts">
                        <label class="form_title">
                    ...
                    <div class="goodsbtn_div formdiv_btn">
                        ...
                        <botton class="goods_btn goodsbtn_act" onclick="detailsSpellGroup(this)">编辑</botton>
                    </div>
                </div>
...
<script type="text/javascript" src="__PC__/js/seller_sales_promotion/spell_group/spell_group_details.js"></script>
