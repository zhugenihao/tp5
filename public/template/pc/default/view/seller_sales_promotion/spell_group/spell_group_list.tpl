...
<div class="seller-allas">
    <div class="member-yue"><span>拼团管理</span></div>
    ...
    <div class="churuzhang">
        ...
        <form class="" action="" method="post" id="secondskill_from" class="floatleft">
            <div class="zhanglx zhanglxpad">
                ...
                <input type="text" value="{:input('search')}" name="search" class="member_text" placeholder="拼团名称"/>
        ...
        <div class="divtitle_btn">
            ...
            <div class="floatright">
                <a href="{:url('seller_sales_promotion.spell_group/spell_group_add',['top'=>4,'type'=>2])}" class="mall_btn goodsbtn_act">
                    <i class="Hui-iconfont">&#xe600;</i>
                    添加拼团
                </a>
            </div>
        ...
        <table border="1" class="churuzhang-tb floatfalse">
            ...
            <tbody class="churuzhang-ty">
                {volist name="spellGroup['data']" id="vo"}
                <tr class="tbcenter">
                    ...
                    <td>
                        <div class="order-btn">
                            <a href="{:url('seller_sales_promotion.spell_group/spell_group_details',['top'=>4,'type'=>2,'spell_group_id'=>$vo['id']])}">编辑</a>
                            <a href="javascript:;" onclick="delSecondskill(this)" data-spellgroupid="{$vo['id']}">删除</a>
                        </div>
                    </td>
                </tr>
                {/volist}
                {if $spellGroup['total'] < 1}
