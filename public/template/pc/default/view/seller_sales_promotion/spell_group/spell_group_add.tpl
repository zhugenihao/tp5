...
<div class="seller-allas">
    <div class="member-yue"><span>添加拼团</span></div>
            ...
            <form action="" method="post" id="brand_from" name="submitfrom" enctype="multipart/form-data">
                <div class="fromtext_auto">
                    ...
                    <div class="div_texts">
                        ...
                        <div class="form_text">
                            <input type="text" name="sg_price" value="1.00" class="mall_input" id="sg_price" size="40">
                        </div>
                    </div>
                    ...
                    <div class="div_texts">
                        ...
                        <div class="form_text">
                            <input type="text" value="10" name="sg_num" class="mall_input" id="sg_num" size="40">
                        </div>
                    </div>
                    <div class="div_texts">
                        <label class="form_title">
                        ...
                        <div class="form_text">
                            <input type="text" value="10" name="sg_members_num" class="mall_input" id="sg_members_num" size="40">
                        </div>
                    </div>
                    <div class="div_texts">
                        <label class="form_title">
...
<script type="text/javascript" src="__PC__/js/seller_sales_promotion/spell_group/spell_group_add.js"></script>
