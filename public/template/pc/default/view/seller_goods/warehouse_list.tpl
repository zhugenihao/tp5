...
<div class="seller-allas">
    <div class="member-yue"><span>仓库中的商品</span></div>
    <div class="churuzhang">
        ...
        <div class="divtitle_btn">
            <div class="floatleft">
                <a href="javascript:;" class="mall_btn goodsbtn_red" onclick="delGoods(this)">
        ...
        <table border="1" class="churuzhang-tb">
            ...
            <tbody class="churuzhang-ty">
                ...
                <tr class="tbcenter">
                    ...
                    <td>
                        <div class="order-btn">
                            <a href="{:url('seller_goods/goods_details',['goods_id'=>$vo['goods_id']])}">商品详情</a>
                            <a href="javascript:;" onclick="delGoods(this)" data-goodsid="{$vo['goods_id']}">删除</a>
...
<script type="text/javascript" src="__PC__/js/seller_goods/goods_list.js"></script>
