...
<form action="" method="post" name="submitfrom" enctype="multipart/form-data">
    <div class="fromtext_auto">
        ...
        <div class="div_texts">
            ...
            <div class="form_text">
                <input type="text" name="color_name" value="颜色名称" placeholder="颜色名称" class="mall_input" id="color_name" size="40">
            </div>
        </div>
        <div class="div_texts">
            <label class="form_title2">
        ...
        <div class="goodsbtn_div formdiv_btn">
            ...
            <botton class="goods_btn goodsbtn_act" onclick="addGoodsColor(this)">添加</botton>
        </div>
    </div>
</form>

{include file="public/seller/directory_list" /}
<script type="text/javascript" src="__PC__/js/seller_specifications/goodscolor/goodscolor_add.js"></script>
