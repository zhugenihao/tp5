...
<form action="" method="post" name="submitfrom" enctype="multipart/form-data">
    <div class="fromtext_auto">
        ...
        <div class="div_texts">
            ...
            <div class="form_text">
                <input type="text" name="color_name" value="{$info['color_name']}" placeholder="颜色名称" class="mall_input" id="color_name" size="40">
            </div>
        </div>
        <div class="div_texts">
            <label class="form_title2">
        ...
        <div class="div_texts">
            ...
            <div class="form_text">
                <select name="color_show" class="">
                    <option value="1" {eq name="info['color_show']" value="1"} selected{/eq}>显示</option>
                    <option value="0" {eq name="info['color_show']" value="0"} selected{/eq}>隐藏</option>
                </select>
            </div>
        </div>
        ...
        <div class="goodsbtn_div formdiv_btn">
            ...
            <botton class="goods_btn goodsbtn_act" onclick="detailsGoodsColor(this)">编辑</botton>
        </div>
    </div>
</form>

{include file="public/seller/directory_list" /}
<script type="text/javascript" src="__PC__/js/seller_specifications/goodscolor/goodscolor_details.js"></script>
