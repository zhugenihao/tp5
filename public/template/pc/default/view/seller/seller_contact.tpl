...
<html>
    ...
    <body>
                    ...
                    <div class="login-text">
                        <form method="post" enctype="multipart/form-data" name="formsubmit" class="layui-form login-text2">
                            ...
                            <ul class="login-ul floatfalse">
                                <li class="login-li">
                                    <div class="bacg-lihui">
                                        <div class="bacgli-auto">
                                            <div>联系信息</div>
                                            <div class="bacgli-title2">联系人信息,用于接收平台官方反馈的入驻通知</div>
                                        </div>
                                    </div>
                                ...
                                <li class="login-li">
                                    <span>联系人姓名</span>
                                    <input type="text" value="{$info['contact_name']}" name="contact_name" class="loginli-input" placeholder="请输入联系人姓名" id="contact_name"/>
                                </li>
                                <li class="login-li">
                                    <span>联系人手机</span>
                                    <input type="text" value="{$info['contact_mobile']}" name="contact_mobile" class="loginli-input" placeholder="请输入联系人手机" id="contact_mobile"/>
                                </li>
                                <li class="login-li">
                                    <span>联系人电子邮箱</span>
                                    <input type="text" value="{$info['contact_email']}" name="contact_email" class="loginli-input" placeholder="请输入电子邮箱" id="contact_email"/>
                                </li>

                                <li class="login-li">
                                    <span>申请类型</span>
                                    <div class="appltype">
                                        <input type="radio" name="application_type" {if !$info['id']||$info['application_type']==1}checked{/if} value="1" title="个人入驻" />
                                        <input type="radio" name="application_type" {eq name="info['application_type']" value="2"}checked{/eq} value="2" title="企业入驻" />
                                    </div>
                                </li>
                                <li class="login-li li-submit">
                                    <input type="button" value="下一步,填写公司信息" class="login-btn" onclick="contactSubmit(this);"/>
                                </li>
                            </ul>
                        </form>
                    </div>
        ...
        <script type="text/javascript" src="__PC__/js/seller/seller_contact.js"></script>
