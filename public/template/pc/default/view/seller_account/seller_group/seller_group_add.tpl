    ...
    <form action="" method="post" name="submitfrom" enctype="multipart/form-data">
        <div class="fromtext_auto">
            <div class="div_texts">
                ...
                <div class="form_text">
                    <input type="text" name="group_name" value="" placeholder="账号组名称" class="mall_input" id="group_name" size="20">
                </div>
            </div>
            <div class="div_texts">
                <label class="form_title2">
                            ...
                            <tr class="textleft">
                                <th width="200">
                                    <div class="goods-names">
                                        <label><input type="checkbox" value="{$vo['id']}" name="menu_id[]" class="checkedAll"/>{$vo['menu_name']}</label>
                                    </div>
                                </th>
                                <th></th>
                            </tr>
                            ...
                            <tr class="tbcenter checketr">
                                <td >
                                    <div class="goods-names textright">
                                        <label><input type="checkbox" value="{$vo2['id']}" name="menu_id[]" class="checkboxzi"/>{$vo2['menu_name']}</label>
                                    </div>
                                </td>
                                <td>
                                    <div class="tablediv-name2">
                                        ...
                                        <div class="goods-names floatleft">
                                            <label><input type="checkbox" value="{$vo3['id']}" name="menu_id[]" class="checkboxzi"/>{$vo3['menu_name']}</label>
                                        </div>
                                        {/volist}
                                    </div>
                                </td>
            ...
            <div class="goodsbtn_div formdiv_btn">
                ...
                <botton class="goods_btn goodsbtn_act" onclick="addSellerGroup(this)">添加</botton>
            </div>
        </div>
    </form>
</div>

<script type="text/javascript" src="__PC__/js/seller_account/seller_group/seller_group_add.js"></script>
