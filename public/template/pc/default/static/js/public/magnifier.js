(function ($) {
    ...
    window[fnName] = function (magnifierAttr) {
        ...
        _this.eqImg = function () {
            ...
            var img = new Image(),
                    src = _this.thumbnail.find("img").eq(magnifier.index).attr('bigimg');
            ...
            _this.thumbnail.find('>*').removeClass('active1').eq(magnifier.index).addClass('active1');
...
//		var thumbnailImg = _this.thumbnail.find('>*'),
        var thumbnailImg = $(".animation03 li"),
