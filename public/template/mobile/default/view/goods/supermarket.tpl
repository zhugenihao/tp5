...
<html>
    <head>
        ...
        <link rel="stylesheet" type="text/css" href="__MOBILE__/css/goods/supermarket.css" />
    ...
    <body>
        ...
        <div class="allhtml">
            ...
            <div class="home-all allas">
                ...
                <div class="advertsas">
                    {if $supermarket_advert20['dire']!=''}
                        <a href="{$supermarket_advert20['adv_link']}"><img src="__STATIC__/{$supermarket_advert20['dire']}" class="advertsas-img"/></a>
                        {/if}
                </div>
                ...
                <div class="tejiayouhui-all floatfalse">
                    ...
                    <ul class="tejiayouhui-ul">
                        {volist name="supermarketGoodsList" id="vo"}
        ...
        <script type="text/javascript" src="__MOBILE__/js/goods/supermarket.js"></script>
