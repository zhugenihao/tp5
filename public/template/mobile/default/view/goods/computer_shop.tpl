...
<html>
    <head>
        ...
        <link rel="stylesheet" type="text/css" href="__MOBILE__/css/goods/computer_shop.css" />
    ...
    <body>
        ...
        <div class="allhtml">
            ...
            <div class="home-all allas">
                ...
                <div class="advertsas">
                    {if $computer_shop_advert20['dire']!=''}
                        <a href="{$computer_shop_advert20['adv_link']}"><img src="__STATIC__/{$computer_shop_advert20['dire']}" class="advertsas-img"/></a>
                        {/if}
                </div>
                ...
                <div class="tejiayouhui-all floatfalse">
                    ...
                    <ul class="tejiayouhui-ul">
                        {volist name="computerGoodsList" id="vo"}
        ...
        <script type="text/javascript" src="__MOBILE__/js/goods/computer_shop.js"></script>
