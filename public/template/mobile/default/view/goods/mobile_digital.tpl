...
<html>
    <head>
        ...
        <link rel="stylesheet" type="text/css" href="__MOBILE__/css/goods/mobile_digital.css" />
    ...
    <body>
        ...
        <div class="allhtml">
            ...
            <div class="home-all allas">
                ...
                <div class="advertsas">
                    <a href="{$mobile_digital_advert20['adv_link']}"><img src="__STATIC__/{$mobile_digital_advert20['dire']}" class="advertsas-img"/></a>
                </div>
        ...
        <script type="text/javascript" src="__MOBILE__/js/goods/mobile_digital.js"></script>
