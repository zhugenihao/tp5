...
<html>
    <head>
        ...
        <link rel="stylesheet" type="text/css" href="__MOBILE__/css/goods/electrical_appliances.css" />
    ...
    <body>
        ...
        <div class="allhtml">
            ...
            <div class="home-all allas">
                ...
                <div class="advertsas">
                    {if $electrical_appliances_advert20['dire']!=''}
                        <a href="{$electrical_appliances_advert20['adv_link']}"><img src="__STATIC__/{$electrical_appliances_advert20['dire']}" class="advertsas-img"/></a>
                        {/if}
                </div>
                ...
                <div class="tejiayouhui-all floatfalse">
                    ...
                    <ul class="tejiayouhui-ul">
                        {volist name="electricalGoodsList" id="vo"}
        ...
        <script type="text/javascript" src="__MOBILE__/js/goods/electrical_appliances.js"></script>
