...
(function ($) {
    ...
    $.fn.lightGallery = function (options) {
        var defaults = {
            mode: 'slide',
            useCSS: true,
            easing: 'cubic-bezier(0.15, 0, 0.15, 0.5)', //'cubic-bezier(0.25, 0, 0.25, 1)','linear'//
            speed: 1000,
            closable: true,
            loop: false,
            auto: false,
            ...
            dynamicEl: [],
            indexer:0,//子标签的位置
            clickOnMultipleNested:false,//click事件里包含click事件是否同时执行
            onOpen: function () {},
            ...
            init: function () {
                el.each(function () {
                    ...
                    if (settings.dynamic == true) {
                        ...
                        if(settings.clickOnMultipleNested == false){
                           ...
                           if (settings.rel == true && $this.data('rel')) {
                            ...
                            index = $children.index($children.eq(indexer));
                        }
                        prevIndex = index;
                        setUp.init(index); 
                    }
