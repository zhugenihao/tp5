...
(function(e) {
    ...
    var d = $,
        ...
        c = d('<div class="c-float-popWrap msgMode hide">'+
				   '<div class="weui_mask_transparent" style="width:'+bodywidth+'px;height:'+bodyheight+'px"></div>'+
    ...
    d.extend(e.prototype, {
        _init: function() {
            ...
            t && o.html(t[0]);
            t && p.html(t[1]);
//			$("body").append('<div class="weui_mask_transparentas"></div>');
...
//            $(".weui_mask_transparentas").css("opacity", "0").remove();
            a && a.call(this)
        },
        hide: function() {
            var a = this;
...
//                $(".weui_mask_transparentas").animate({"opacity": "0"}).remove();
            }, 1))
