...
class Goods extends Common {
    ...
    public function recommended() {
        if ($this->request->isAjax()) {
            ...
            $goodsRecommendedList = GoodsModel::getGoodsList(['recommended' => 1], $field, $get['start'], $get['limit'], ['number_payment' => 'desc']);
            exit(json_encode($goodsRecommendedList));
        }
        ...
        $this->assign('recommended_advert20', $recommended_advert20);
        return $this->fetch();
    }
    ...
    public function mobile_digital() {
        ...
        $this->assign('directoryTitle', directoryModel::getValue(['id' => $dirId], 'title'));
        //轮播图片
        $advertList = advertModel::getAdvertlist('mobile_digital_advert', 1, 2, 6);
        $this->assign('advertList', $advertList);
        //单图广告
        $mobile_digital_advert2 = advertModel::getAdvertlist('mobile_digital_advert', 2, 2, 6);
        ...
        $mobileGoodsList = GoodsModel::getGoodsList(['dir_id' => ['in', $dirIdArr]], $mobilefield, 0, 10, ['sales' => 'desc']);
